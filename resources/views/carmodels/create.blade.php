                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="category_id">Select Manufacturer <span
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="manufacturing_year" id="manufacturing_year"
                                                class="form-control" placeholder="Enter Manufacturing Year" required>
...
@section('extrajs')
    ...
    <script type="text/javascript">
        $("#button_submit").on('click', function(event) {
            ...
            console.log('manufacturer_name', manufacturer_name);
